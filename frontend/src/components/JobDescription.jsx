    ...
    return (
        ...
        <div className='max-w-7xl mx-auto'>
            ...
            <div className='flex items-center justify-between my-8'>
                ...
                <Button onClick={isApplied ? null : applyJobHandler} disabled={isApplied} className={`rounded-lg ${isApplied ? 'bg-gray-600 cursor-not-allowed' : 'bg-[#6a38C2] hover:bg-[#5b30a6] cursor-pointer'}`}>{isApplied ? 'Already Applied' : 'Apply now'}</Button>
            </div>
            ...
            <div className='my-4'>
                ...
                <h1 className='font-bold my-1'>Total Allicants: <span className='pl-4 font-normal text-gray-800'>{singleJob?.applications?.length}</span></h1>
